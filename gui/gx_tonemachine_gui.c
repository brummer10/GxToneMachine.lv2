...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = (gx_controller) {{ 0.5, 0.5, 0.0, 1.0, 0.01},{ 50, 30, 61, 61}, false,"VOLUME", KNOB, VOLUME};
	ui->controls[1] = (gx_controller) {{ 0.5, 0.5, 0.0, 1.0, 0.01},{ 120, 30, 61, 61}, false,"SUSTAIN", KNOB, SUSTAIN};
	ui->controls[2] = (gx_controller) {{ 0.0, 0.0, 0.0, 1.0, 1.0}, { 190, 30, 61, 61}, false,"OCTAVE", SWITCH, OCTAVE};
	ui->controls[3] = (gx_controller) {{ 0.5, 0.5, 0.0, 1.0, 0.01},{ 260, 30, 61, 61}, false,"TONE", KNOB, TONE};
	ui->block_event = -1;
